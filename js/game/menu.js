...
function Play(message){
	...
	if(!$.asked_about && !$.asked_credits){
		...
		R("그런 똥씹은 표정이라니...");
		Wait(800);
		R("네가 스킵을 한다고 했지만! 소개를 하자면 나는 라울이고-");
		p("스킵! 스킵!");
...
function tw_play(){
	...
	Wait(800);
	R("모든 선택지는 진실일수도, 거짓일 수도 있어.");
	R("내 친구에겐 거짓이어도,");
	Wait(800);
	R("누군가에겐 진실일수도, 그 반대일수도 있지.");
	p("진지하면서 복잡한걸...");
	R("인생이라는 게 그런 거 아니겠어?");
				Choose({
			"이 게임에 진실과 거짓이 섞여있다는 말이야?": function(message){
				p("이 게임에 진실과 거짓이<br>섞여있다는 말이야?");
				R("맨 처음 말했듯, 그렇지.");
				R("벌써 몇년이나 지난 일이야.");
